...
namespace FloorSimulation
{
    ...
    internal class StartHub: Hub
    {
        ...
        public StartHub(string name_, int id_, Point FPoint_, Floor floor_, int initial_trolleys_ = 0, bool vertical_trolleys_ = true) : base(name_, id_, FPoint_, floor_, new Size(400, 200), initial_trolleys:initial_trolleys_, vertical_trolleys:vertical_trolleys_)
        {
        }
